  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Menu Beverage</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

    <div><h1 class="teks3" align = "center">ADD MENU BEVERAGE</h1></div>
    <div class="kotak4">
        <form action=""></form>
          <label for="">Type of Beverage: </label>
            <select name="" id="">
            ...
            <label for="">Beverage Pictures: </label>
